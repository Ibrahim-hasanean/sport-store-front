...
function App() {
  ...
  const [buyOneItem, setBuyOneItem] = useState([]);
  ...
  return (
    <div className="App">
      <AuthContext.Provider
        value={{ isToken, setToken, userData, setUserData, logout }}
      >
            ...
            <div>
              <Switch>
                ...
                <ProtectRoute
                  exact
                  path="/TeamItemsPage"
                  component={TeamItemsPage}
                />
                <ProtectRoute
                  exact
                  path="/items/payment/summary"
                  component={PaymentSummary}
                />
                <ProtectRoute
                  exact
                  path="/items/payment/userDetailes"
                  component={BuyUserDetailes}
                />
                <ProtectRoute
                  exact
                  path="/items/payment/buy"
