...
let Home = () => {
  ...
  const [popular, setPopularItems] = useState({
    limit: 15,
    skip: 0,
    items: [],
    hasMore: true,
  ...
  const [sales, setSalesItems] = useState({
    limit: 15,
    skip: 0,
    items: [],
    hasMore: true,
  ...
  const hotItemsArray = [
    ...
    },
    {
      ...
      price: "$60",
      mainImage:
        "https://storage.googleapis.com/sport-store-290016.appspot.com/1601389371577cover1.jpg?GoogleAccessId=firebase-adminsdk-4jbpj%40sport-store-290016.iam.gserviceaccount.com&Expires=16447010400&Signature=qMNRq%2FrRpBXHoCu8ia9Gw2jIZyLVdSUYNxv%2BHIV2DTFmbEeTg7RGp7%2FEhuciJvKpOnfXd3pfiuMAFrJ%2F7IBU0MPOIvNc5TnTdP6VtENKClHWeqx1hDqoDJu9l6ePwCHwu9G0CmhvrsEbDGTDp93m37waLWM0oJ%2BEij0yak5SUeEcc8d4Z38iNmmNFXYPfWS%2FmWi4UIx%2FpfjFpEWUVwgnr1Px92Rq4Ufrd4oc1vY8kkuTs1gWN2mujEtfTcUAQqkj87Kg6rEZ0jb9ONzZXL3uxEZDj%2BZfBZAee1NnJnc2bCnPbSl%2FS15WJIeO8sdH7FNtyqiBzNNbqXmhmBN%2BINLCQQ%3D%3D",
    },
    {
      _id: "5f7748ed1872bd00179a1b78",
      team: "Real Madrid",
  ...
  const filterBuyItems = () => {
    let newItems = buyItems.filter((x) => x.checked);
  ...
  const homeItems = async () => {
    try {
      ...
      let items = await axios.get(`${url}/api/v1/items/home`, {
