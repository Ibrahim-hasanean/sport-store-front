...
let  Home=() => {   
    ...
    const homeItems =async ()=>{
        ...
        let items = await axios.get("https://sportstore1.herokuapp.com/api/v1/items/home",{headers:{"x-access-token":token}})
    ...
    return (       
        ...
        {search.length === 0?
            <>
                ...
                <HotItemsContainer hotItems={hotItems}/>
                <TeamsSlider/>             
                <Items setNewItems={setNewItems} setPopularItems={setPopularItems}  popular={popular} newItems={newItems} sales={sales} />    
            </>
